...
for target in .bundle .git-template .ansible.cfg .ctags .remarkrc .gitconfig .peco .tigrc .tmux.conf .vimrc .rspec .zazurc.json .config/karabiner.json .config/assets; do
